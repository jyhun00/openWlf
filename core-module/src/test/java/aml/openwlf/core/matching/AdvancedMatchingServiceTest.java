...
class AdvancedMatchingServiceTest {
    ...
    @BeforeEach
    void setUp() {
        // 전략 객체들을 생성하여 AdvancedMatchingService에 주입
        SoundexMatchingStrategy soundexStrategy = new SoundexMatchingStrategy();
        MetaphoneMatchingStrategy metaphoneStrategy = new MetaphoneMatchingStrategy();
